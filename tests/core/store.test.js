...
describe('Store ', () => {
    ...
    it('can get a store by name', async () => {
        const { new_store } = await create_owner_and_store();
    ...
    it('can be patched with a manager', async () => {
    ...
    it('can\'t be patched with a user that is not a manager', async () => {
        const { new_store } = await create_owner_and_store();
        expect(new_store).toBeTruthy();
    ...
    it('can\'t be tagged with a user that is not a manager', async () => {
        const { new_store } = await create_owner_and_store();
        expect(new_store).toBeTruthy();
        const other_user = await create_user_two();
        expect(other_user).toBeTruthy();
    ...
    it('can validate if a user is a manager', async () => {
        const { owner, new_store } = await create_owner_and_store();
        expect(new_store).toBeTruthy();
    ...
    it('can add a user as manager by a manager', async () => {
        const { owner, new_store } = await create_owner_and_store();
        expect(new_store).toBeTruthy();
        expect(store.is_manager(new_store, owner._id)).toBeTruthy();
        const other_user = await create_user_two();
